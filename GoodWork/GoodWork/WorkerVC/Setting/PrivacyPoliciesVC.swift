...
class PrivacyPoliciesVC: BaseVC {
    
    static let storyBoardIdentifier = "PrivacyPoliciesVC"
...
extension PrivacyPoliciesVC {
    func getPrivacyPoliciesAPI(){
        ...
        LoginDataManager.shared.getPrivacyPoliciesAPI(rqst: mdl) { (dict, error) in
