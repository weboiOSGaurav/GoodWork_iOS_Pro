...
class MoveToDoneRCVC: UIViewController {
    
    static let storyBoardIdentifier = "MoveToDoneRCVC"
    ...
    func setUPUI(){
        ...
        self.submittedDateTitleLabel.addTitleColorAndFont(title: "Start Date:", fontName: GoodWorkAppFontName.NeueKabelRegular, fontSize: 13, tintColor: GoodWorkAppColor.appLightPink)
        
        self.submittedDateDetailsLabel.addTitleColorAndFont(title: "28th Feb, 2023", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
...
extension MoveToDoneRCVC : UITableViewDelegate, UITableViewDataSource {
