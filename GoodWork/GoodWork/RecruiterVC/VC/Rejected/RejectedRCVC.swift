...
class RejectedRCVC: UIViewController {
    
    static let storyBoardIdentifier = "RejectedRCVC"
    ...
    func setUPUI(){
        ...
        self.submittedDateTitleLabel.addTitleColorAndFont(title: "Employment Duration:", fontName: GoodWorkAppFontName.NeueKabelRegular, fontSize: 13, tintColor: GoodWorkAppColor.appLightPink)
        
        self.submittedDateDetailsLabel.addTitleColorAndFont(title: "28th Feb, 2023 - 14th April, 2023", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
        self.submittedDateDetailsLabel.numberOfLines = 0
        self.submittedDateDetailsLabel.clipsToBounds = true
...
extension RejectedRCVC : UITableViewDelegate, UITableViewDataSource {
