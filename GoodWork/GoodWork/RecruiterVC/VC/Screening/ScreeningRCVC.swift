...
class ScreeningRCVC: UIViewController {
    
    static let storyBoardIdentifier = "ScreeningRCVC"
    ...
    func setUPUI(){
        ...
        self.appDetailsLabel.addTitleColorAndFont(title: "Screening Applicants", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 18, tintColor: GoodWorkAppColor.appDarkPurple)
...
extension ScreeningRCVC : UITableViewDelegate, UITableViewDataSource {
