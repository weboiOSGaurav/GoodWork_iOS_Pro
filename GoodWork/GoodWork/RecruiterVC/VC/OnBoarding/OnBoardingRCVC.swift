...
class MoveToOnBoardingRCVC: UIViewController {
    
    static let storyBoardIdentifier = "MoveToOnBoardingRCVC"
    ...
    func setUPUI(){
        ...
        self.submittedDateTitleLabel.addTitleColorAndFont(title: "Offered Date:", fontName: GoodWorkAppFontName.NeueKabelRegular, fontSize: 13, tintColor: GoodWorkAppColor.appLightPink)
        
        self.submittedDateDetailsLabel.addTitleColorAndFont(title: "24th Feb, 2023", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
...
//MARK:- Button Actions
extension MoveToOnBoardingRCVC {
...
extension MoveToOnBoardingRCVC : UITableViewDelegate, UITableViewDataSource {
