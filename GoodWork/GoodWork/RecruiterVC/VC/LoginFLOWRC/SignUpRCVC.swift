...
class SignUpRCVC: BaseVC {
    
    static let storyBoardIdentifier = "SignUpRCVC"
...
extension SignUpRCVC : UITextFieldDelegate{
...
extension SignUpRCVC {
    ...
    func signUpAPI(){
        ...
        LoginDataManager.shared.rcRegisterNewUser(rqst: mdl) { (dict, error) in
