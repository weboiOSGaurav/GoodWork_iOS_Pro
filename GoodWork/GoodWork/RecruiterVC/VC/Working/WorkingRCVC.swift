...
class WorkingRCVC: UIViewController {
    
    static let storyBoardIdentifier = "WorkingRCVC"
    ...
    func setUPUI(){
        ...
        self.submittedDateTitleLabel.addTitleColorAndFont(title: "On Boarding Date:", fontName: GoodWorkAppFontName.NeueKabelRegular, fontSize: 13, tintColor: GoodWorkAppColor.appLightPink)
...
extension WorkingRCVC : UITableViewDelegate, UITableViewDataSource {
