...
class NurseDetailsRCVC: UIViewController {
    
    static let storyBoardIdentifier = "NurseDetailsRCVC"
    ...
    @IBOutlet weak var jobStatusView: UIView!
    @IBOutlet weak var jobStatusHeightConstrain: NSLayoutConstraint!
    @IBOutlet weak var jobStatusTitleLabel: UILabel!
    @IBOutlet weak var jobStatusDescriptionLabel: UILabel!
    ...
    @IBOutlet weak var employerHeightConstrain: NSLayoutConstraint!
    
    @IBOutlet weak var employerTitleLabel: UILabel!
    @IBOutlet weak var employerDescriptionLabel: UILabel!
    
    @IBOutlet weak var submittedDateTitleLabel: UILabel!
    @IBOutlet weak var submittedDateDescriptionLabel: UILabel!
    
    
    @IBOutlet weak var jobAppliedToptConstrain: NSLayoutConstraint!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.jobStatusHeightConstrain.constant = 0
        self.jobStatusView.isHidden = true
        
        self.employerHeightConstrain.constant = 0
        self.employerView.isHidden = true
        
        
        if self.isScreening {
            self.jobStatusHeightConstrain.constant = 48
            self.jobStatusView.isHidden = false
            
            self.jobAppliedToptConstrain.constant = 10
        }else if self.isEmployees{
            self.jobStatusHeightConstrain.constant = 48
            self.employerHeightConstrain.constant = 48
            self.employerView.isHidden = false
            self.jobAppliedToptConstrain.constant = 14
    ...
    func setUPUI(){
        ...
        self.jobStatusTitleLabel.addTitleColorAndFont(title: "Job Status", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 14, tintColor: GoodWorkAppColor.appBlue)
        
        self.jobStatusDescriptionLabel.addTitleColorAndFont(title: "Screening", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
        ...
        self.employerDescriptionLabel.addTitleColorAndFont(title: "AGC Hospital", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
        
        
        self.submittedDateTitleLabel.addTitleColorAndFont(title: "Submitted Date:", fontName: GoodWorkAppFontName.NeueKabelRegular, fontSize: 14, tintColor: GoodWorkAppColor.appLightPink)
        
        self.submittedDateDescriptionLabel.addTitleColorAndFont(title: "14th Feb, 2023", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
        
        self.updateStatusLabel.addTitleColorAndFont(title: "Update", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 13, tintColor: GoodWorkAppColor.appDarkPurple)
...
extension NurseDetailsRCVC {
    ...
    func buttonActions(){
        ...
        self.updateStatusButton.addTarget(self, action: #selector(self.updateStatusButtonPressed(_:)), for: .touchUpInside)
    }
    ...
    @IBAction func updateStatusButtonPressed(_ sender: UIButton){
        print("uodateStstusButtonPressed")
        guard let vc = recruiterStoryboard.instantiateViewController(withIdentifier: UpdateJobStatusViewController.storyBoardIdentifier) as? UpdateJobStatusViewController else { return }
...
extension NurseDetailsRCVC : UITableViewDelegate, UITableViewDataSource {
