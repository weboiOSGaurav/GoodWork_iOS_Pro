...
class OnboardingEmployeesRCVC: UIViewController {
    
    static let storyBoardIdentifier = "OnboardingEmployeesRCVC"
    ...
    func setUPUI(){
        ...
        self.appDetailsLabel.addTitleColorAndFont(title: "Onboarding Employees ", fontName: GoodWorkAppFontName.NeueKabelMedium, fontSize: 18, tintColor: GoodWorkAppColor.appDarkPurple)
...
//MARK:- Button Actions
extension OnboardingEmployeesRCVC {
...
extension OnboardingEmployeesRCVC : UITableViewDelegate, UITableViewDataSource {
