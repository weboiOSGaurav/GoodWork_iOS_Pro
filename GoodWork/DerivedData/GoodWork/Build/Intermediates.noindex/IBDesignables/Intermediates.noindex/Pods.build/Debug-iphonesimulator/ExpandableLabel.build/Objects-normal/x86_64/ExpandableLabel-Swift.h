...
#ifndef EXPANDABLELABEL_SWIFT_H
#define EXPANDABLELABEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpandableLabel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// ExpandableLabel
SWIFT_CLASS("_TtC15ExpandableLabel15ExpandableLabel")
@interface ExpandableLabel : UILabel
/// The delegate of ExpandableLabel
@property (nonatomic, weak) id <ExpandableLabelDelegate> _Nullable delegate;
...
@interface ExpandableLabel (SWIFT_EXTENSION(ExpandableLabel))
...
/// The delegate of ExpandableLabel.
SWIFT_PROTOCOL("_TtP15ExpandableLabel23ExpandableLabelDelegate_")
